  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          <div className="flex items-center space-x-2 bg-gray-100 rounded-lg p-1">
            <button
              type="button"
              className="px-4 py-2 rounded-md text-sm font-medium flex items-center space-x-2 bg-white text-gray-900 shadow-sm"
            >
            ...
            <button
              ...
              className="px-4 py-2 rounded-md text-sm font-medium flex items-center space-x-2 text-gray-600 hover:text-gray-900"
            >
      ...
      <div className="card flex items-center justify-between">
        <div>
          <h2 className="text-base font-semibold text-gray-900">ガントチャート</h2>
          <p className="text-sm text-gray-500 mt-1">ガントは専用ページで表示します</p>
        </div>
        <button
          type="button"
          onClick={() => navigate('/gantt')}
