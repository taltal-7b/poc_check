...
const envSchema = z.object({
  ...
  AI_PROGRESS_SUMMARY_MODEL: envString('gpt-5-nano'),
  ...
  AI_PROGRESS_SUMMARY_MAX_OUTPUT_TOKENS: z.coerce.number().int().min(100).max(4000).default(2000),
  ...
  AI_WEEKLY_REPORT_MODEL: envString('gpt-5-nano'),
  ...
  AI_WEEKLY_REPORT_MAX_OUTPUT_TOKENS: z.coerce.number().int().min(100).max(6000).default(3000),
  ...
  AI_BOTTLENECK_DETECTION_MODEL: envString('gpt-5-nano'),
